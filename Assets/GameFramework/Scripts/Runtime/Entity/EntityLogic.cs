...
namespace UnityGameFramework.Runtime
{
    ...
    {
        private bool m_Available = false;              //实体是否不可用
        private bool m_Visible = false;                //显示还是隐藏
        private Entity m_Entity = null;                //具体的实体
        private Transform m_CachedTransform = null;    //其实也就是自身的 Transform
        private int m_OriginalLayer = 0;               //所在的层
        private Transform m_OriginalTransform = null;  //最开始的实体的 Parget Transform
