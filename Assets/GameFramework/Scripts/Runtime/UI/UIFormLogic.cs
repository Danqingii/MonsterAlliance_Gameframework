...
namespace UnityGameFramework.Runtime
{
    ...
    public abstract class UIFormLogic : MonoBehaviour
    {
        ...
        private UIForm m_UIForm = null;               //具体的Form
        private Transform m_CachedTransform = null;   //缓存的自己
        private int m_OriginalLayer = 0;              //层级
