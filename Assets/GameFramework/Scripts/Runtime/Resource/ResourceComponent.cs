...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        private bool m_EditorResourceMode = false;          //是否是编辑器资源模式
        private bool m_ForceUnloadUnusedAssets = false;     //可以更新的资源
        private bool m_PreorderUnloadUnusedAssets = false;  //预加载资源流程
        private bool m_PerformGCCollect = false;            //是否秦楚多余的辣鸡
        private AsyncOperation m_AsyncOperation = null;     //执行的开始异步
        private float m_LastUnloadUnusedAssetsOperationElapseSeconds = 0f;
        private ResourceHelperBase m_ResourceHelper = null; //具体的管理器帮助者
