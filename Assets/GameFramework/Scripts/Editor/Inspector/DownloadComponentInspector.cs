...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class DownloadComponentInspector : GameFrameworkInspector
    {
        ...
        //得到 DownloadComponent 的 m_DownloadAgentHelperTypeName指定信息
        private readonly HelperInfo<DownloadAgentHelperBase> m_DownloadAgentHelperInfo = new HelperInfo<DownloadAgentHelperBase>("DownloadAgent");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                //创建一个可改变的下载代理辅助器滑动条 最小值为1 最大值为16
