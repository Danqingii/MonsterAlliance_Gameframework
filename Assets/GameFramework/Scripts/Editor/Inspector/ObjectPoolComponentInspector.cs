...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class ObjectPoolComponentInspector : GameFrameworkInspector
    {
        ...
        //HashSet<T>对象的容量是该对象可以容纳的元素数。甲的HashSet <T>对象的容量作为元素被添加到对象自动增加。
        //所述的HashSet <T>类是基于数学集模型，并提供类似的访问的键高性能组操作字典<TKEY的，TValue>中或哈希表集合。
        //简单来说，HashSet<T>类可以被认为是一个没有值的Dictionary<TKey,TValue>集合。
