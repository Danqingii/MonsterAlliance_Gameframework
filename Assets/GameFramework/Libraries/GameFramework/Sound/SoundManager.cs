...
namespace GameFramework.Sound
{
    ...
    internal sealed partial class SoundManager : GameFrameworkModule, ISoundManager
    {
        ...
        private readonly List<int> m_SoundsBeingLoaded;                    //声音的加载完成
        private readonly HashSet<int> m_SoundsToReleaseOnLoad;             //声音的排除完成加载
        private readonly LoadAssetCallbacks m_LoadAssetCallbacks;          //声音加载回调
