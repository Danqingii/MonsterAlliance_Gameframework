...
namespace GameFramework.Sound
{
    ...
    {
        internal const float DefaultTime = 0f;         //默认时间
        internal const bool DefaultMute = false;       //默认哑巴的
        internal const bool DefaultLoop = false;       //默认循环的
        internal const int DefaultPriority = 0;        //默认层级的
        internal const float DefaultVolume = 1f;       //默认的音量
