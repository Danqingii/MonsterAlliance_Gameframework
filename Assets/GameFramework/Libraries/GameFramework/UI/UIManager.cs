...
namespace GameFramework.UI
{
    ...
    {
        //UI是分组的 所有的UIForm 都是在Group里面的!
        //也就是层级划分
        
        private readonly Dictionary<string, UIGroup> m_UIGroups;       //全部的UI组       
        private readonly Dictionary<int, string> m_UIFormsBeingLoaded; //当前加载完成的Form
        private readonly HashSet<int> m_UIFormsToReleaseOnLoad;        //搬迁后的真正key
        private readonly Queue<IUIForm> m_RecycleQueue;                //全部回收的Form
        private readonly LoadAssetCallbacks m_LoadAssetCallbacks;      
        private IObjectPoolManager m_ObjectPoolManager; 
        private IResourceManager m_ResourceManager;
        private IObjectPool<UIFormInstanceObject> m_InstancePool;
        private IUIFormHelper m_UIFormHelper;
        private int m_Serial;            //唯一的标识
        private bool m_IsShutdown;       //是否关机
