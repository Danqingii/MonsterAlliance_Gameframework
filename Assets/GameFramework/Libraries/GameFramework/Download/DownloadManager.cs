...
namespace GameFramework.Download
{
    ...
    internal sealed partial class DownloadManager : GameFrameworkModule, IDownloadManager
    {
        ...
        private readonly TaskPool<DownloadTask> m_TaskPool;  //任务池
        private readonly DownloadCounter m_DownloadCounter;  //下载计数器 用于更新 节点信息
        private int m_FlushSize;                             //将缓冲区写入磁盘的临界大小
        private float m_Timeout;                             //下载超时时长，以秒为单位
        private EventHandler<DownloadStartEventArgs> m_DownloadStartEventHandler;    //下载开始事件
        private EventHandler<DownloadUpdateEventArgs> m_DownloadUpdateEventHandler;  //下载更新事件
        private EventHandler<DownloadSuccessEventArgs> m_DownloadSuccessEventHandler;//下载成功事件
        private EventHandler<DownloadFailureEventArgs> m_DownloadFailureEventHandler;//下载失败事件
