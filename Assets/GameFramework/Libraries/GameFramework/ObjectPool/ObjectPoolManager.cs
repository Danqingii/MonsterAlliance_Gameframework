...
namespace GameFramework.ObjectPool
{
    ...
    internal sealed partial class ObjectPoolManager : GameFrameworkModule, IObjectPoolManager
    {
        ...
        private readonly Dictionary<TypeNamePair, ObjectPoolBase> m_ObjectPools;  //真正的 对象池- 一个池对应一个类型
        private readonly List<ObjectPoolBase> m_CachedAllObjectPools;             //缓存的临时对象池 在对回收对象时 先保存全部的obj在释放 
        private readonly Comparison<ObjectPoolBase> m_ObjectPoolComparer;         //自定义排序接口 实现为Priority 在前面
