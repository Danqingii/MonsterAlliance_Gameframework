...
namespace GameFramework
{
    public static partial class ReferencePool
    {
        private sealed class ReferenceCollection
        {
            ...
            private int m_UsingReferenceCount;    //使用过的引用数量
            private int m_AcquireReferenceCount;  //获得过的引用数量
            private int m_ReleaseReferenceCount;  //回收过的引用数量
            private int m_AddReferenceCount;      //添加
            private int m_RemoveReferenceCount;   //移除
