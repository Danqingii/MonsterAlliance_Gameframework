...
namespace GameFramework.WebRequest
{
    ...
    internal sealed partial class WebRequestManager : GameFrameworkModule, IWebRequestManager
    {
        ...
        private float m_Timeout;                                                          //请求的时间
        private EventHandler<WebRequestStartEventArgs> m_WebRequestStartEventHandler;     //任务开始请求事件
        private EventHandler<WebRequestSuccessEventArgs> m_WebRequestSuccessEventHandler; //任务请求成功事件
        private EventHandler<WebRequestFailureEventArgs> m_WebRequestFailureEventHandler; //任务请求失败事件
