...
namespace GameFramework.WebRequest
{
    internal sealed partial class WebRequestManager : GameFrameworkModule, IWebRequestManager
    {
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            private WebRequestTask m_Task;                       //具体的web任务
            private float m_WaitTime;                            //等待的时间

            public GameFrameworkAction<WebRequestAgent> WebRequestAgentStart;             //状态
            public GameFrameworkAction<WebRequestAgent, byte[]> WebRequestAgentSuccess;   //请求成功
            public GameFrameworkAction<WebRequestAgent, string> WebRequestAgentFailure;   //请求失败
