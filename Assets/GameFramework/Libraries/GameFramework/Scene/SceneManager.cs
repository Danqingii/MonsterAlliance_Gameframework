...
namespace GameFramework.Scene
{
    ...
    {
        private readonly List<string> m_LoadedSceneAssetNames;      //加载完毕
        private readonly List<string> m_LoadingSceneAssetNames;     //加载中 
        private readonly List<string> m_UnloadingSceneAssetNames;   //卸载
        private readonly LoadSceneCallbacks m_LoadSceneCallbacks;      //场景加载的4个回调
        private readonly UnloadSceneCallbacks m_UnloadSceneCallbacks;  //场景卸载的2个回调
